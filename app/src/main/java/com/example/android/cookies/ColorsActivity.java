...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        word.add(new Word("gray", "ṭopoppi", R.drawable.color_gray, R.raw.color_black));
        ...
        word.add(new Word("dusty yelloy", "ṭopiisә", R.drawable.color_dusty_yellow, R.raw.color_dusty_yellow));
